...
var Search = function () {
    function Search() {
        ...
        this.openBtn = (0, _jquery2.default)('.js-search-trigger');
        this.closeBtn = (0, _jquery2.default)('.search-overlay__close');
        this.searchOverly = (0, _jquery2.default)('.search-overlay');
        this.searchField = (0, _jquery2.default)('#search-term');
        this.Results = (0, _jquery2.default)('#search-overlay__result');
        this.events();
        this.isOpen = false;
    ...
    _createClass(Search, [{
        ...
        value: function keyPress(e) {
            if (e.keyCode === 83 && !this.isOpen && !(0, _jquery2.default)('input, textarea').is(':focus')) {
                this.openOverlay();
            }
